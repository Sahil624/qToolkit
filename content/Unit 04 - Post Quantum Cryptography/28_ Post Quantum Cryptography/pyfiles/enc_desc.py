...
main_header = widgets.HTML("<h1>End-to-End PQC Encryption (ML-KEM)</h1>")
main_description = widgets.HTML("""
...
header_step1 = widgets.HTML("<h2>Step 1: Generate Key Pair</h2>")
description_step1 = widgets.HTML("<p>First, generate a quantum-resistant public and private key pair for the recipient.</p>")
...
# == Step 2: Encryption ==
header_step2 = widgets.HTML("<h2>Step 2: Encrypt a Message</h2>")
description_step2 = widgets.HTML("<p>Next, as the sender, type a message and encrypt it using the recipient's public key from Step 1.</p>")
...
# == Step 3: Decryption ==
header_step3 = widgets.HTML("<h2>Step 3: Decrypt the Message</h2>")
description_step3 = widgets.HTML("<p>Finally, as the recipient, use your private key from Step 1 to decrypt the message received from the sender in Step 2.</p>")
...
full_ui = widgets.VBox([
    ...
    widgets.HTML("<hr><h3>Status Log</h3>"),
    status_output
], layout={'width': '100%'})
